...
# Chapter 4 HW -----------------------------------------------------------------
# As with the previous chapter on data wrangling, a valuable exercise based on this
# chapter is for the reader to use their own data-sets to practice with all the plotting
# methods that are described in the chapter. It may be that different data sets may be required 
# for different types of plots. See additional datasets below 

# Load packages. ggplot2 comes with tidyverse load
library(tidyverse)
...
# There is a weider set of marginal distributions in scatterplots available in ggMarginal function that is part of ggExtra package
...
# Chapter 5 HW ------------------------------------------------------------
# Perform some univariate exploratory analyses. For example, from one or more 
# variables of interest plot their histograms and boxplots, both overall, and when
# the variable is grouped according to values of another variable. In parallel,
# calculate summary statistics measures of central tendency, dispersion, skewness, 
# and kurtosis. Compare the plots to the tables of quantities to be able to get a grasp 
# on how certain summaries of the data manifest themselves visualization, and how 
# certain properties of the plots manifest themselves in summary statistics. For 
# example, see whether histograms with long tails correspond to relatively high 
# values of skewness, and vice versa.
